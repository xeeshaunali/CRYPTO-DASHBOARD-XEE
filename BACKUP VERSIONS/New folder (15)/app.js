...
function updateRealTimeAnalysisUI(analysis) {
    ...
    document.getElementById("rtVolumeTrend").textContent = analysis.buyVolume > analysis.sellVolume ? "↑ Bullish" : "↓ Bearish";
...
function showRealTimeError(message) {
    ...
    document.getElementById("rtSignalIcon").textContent = "❌";
    ...
    container.innerHTML = `
        <div class="card">
            <div class="card-header bg-info text-white">
                <h5 class="mb-0">📊 Detailed Volume Analysis: ${symbol}</h5>
            </div>
            <div class="card-body">
                <div class="row">
                    <div class="col-md-6">
...
function displayRealTimeAlerts(alerts) {
    ...
    alerts.forEach(alert => {
        ...
        alertDiv.innerHTML = `
            <strong>🚨 Volume Spike!</strong> ${alert.symbol}
            <br>
